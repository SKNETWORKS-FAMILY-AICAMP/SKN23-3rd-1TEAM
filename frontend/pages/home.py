...
from utils.api_utils import api_verify_token, inject_custom_header
import yaml
import os
...
from utils.function import inject_custom_header # 1. 함수 불러오기

# 2. 화면 세팅 (page_config) 바로 밑에서 함수 실행!
